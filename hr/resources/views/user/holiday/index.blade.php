...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 style="color: black;">Holiday List</h3>
    </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('user.holiday') }}" method="GET" class="row g-3 align-items-end">
                <div class="col-md-2">
                ...
                <div class="col-md-3">
                    ...
                    <a href="{{ route('user.holiday') }}" class="btn btn-sm btn-outline-secondary">Clear</a>
                </div>
            </form>
        </div>
    </div>
