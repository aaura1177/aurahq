...
<head>
    ...
    <title>Employee / Login - Aurateria</title>
...
<body class="loginbody">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#email, #yourPassword").on("input", function() {
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="index.html" class="logo d-flex align-items-center w-auto">
                                    ...
                                    <span class="d-none d-lg-block">Aurateria Employee</span>
                                </a>
                            </div>
                                    ...
                                    <form action="{{ route('user.login.post') }}" method="POST"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                ...
                                                <div class="invalid-feedback">Please enter your emali.</div>
                                            </div>
                                        </div>
                      ...
                      <div class="form-check">
                        ...
                        <label class="form-check-label" for="rememberMe">Remember me</label>
                            ...
                            <div class="credits">
                                ...
                                Designed by <a href="#">Aurateria Team</a>
                            </div>
    ...
    <script src="{{ asset('user/vendor/quill/quill.js') }}"></script>
