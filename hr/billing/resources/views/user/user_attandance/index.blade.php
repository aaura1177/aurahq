    ...
    <div id="form_container" style="padding: 0;">
      ...
      <form id="editUserForm" method="POST" enctype="multipart/form-data">
       ...
       <div class="form-input">
        ...
        <!-- <span class="error font-8">Max file size 2MB*</span>        -->
       </div>
...
<div class="container mt-4">
    <h3 class="mb-3">Present Employee</h3>
       ...
       @foreach($attendances as $attendance)
        <div class="col-md-4 mb-3">
            <div class="card border-success shadow">
                <div class="card-body">
                    <h5 class="card-title text-success">{{ $attendance->user->name }}</h5>
                    <p class="card-text">
                        <strong>User ID:</strong> {{ $attendance->user->id }} <br>
                        <strong>Check-In:</strong>{{ $attendance->checkin_time ?? '-' }} <br>
                        <strong>Total Check-Ins:</strong> {{ $attendance->user->checkin_count ?? 0 }} <br>
                        <strong>Status:</strong> <span class="badge bg-success">Present</span>
                    </p>
                </div>
            </div>
        </div>
...
<div id="table_data_page">
  <h3 class="main-text-h3">User Attandance</h3>
  <div id="buttons_container">
    <!-- <a href=""><button class="btn success"><i class="fa fa-plus"></i>Create User</button></a> -->
  ...
  <div id="data_container">
    ...
    <div id="table_container">
      <table id="data_table">
        ...
        <td>{{ $index + 1 }}</td>
       <td>   
       <form id="checkInForm" action="{{ route('user.checkin') }}" method="POST">
                @csrf
