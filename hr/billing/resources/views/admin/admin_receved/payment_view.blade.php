...
<div id="table_data_page">
  <h3 class="main-text-h3">Payment View Page</h3>
  <div id="buttons_container">
    
   <!-- <a href="">
      <button class="btn success"><i class="fa fa-plus"></i>Create Payment</button></a>
     -->
  ...
  <div id="data_container">
    ...
    <td>{{ $payment->payment_date  ?? 'N/A'}}</td>
     ...
     <td>{{ $totalWorkingTime }} hours</td>
        ...
        <li onclick='handleTableDelete(this)' data-id="{{ $payment->id }}"><i class="fa fa-trash"></i>Delete</li>
<!-- <a href=""> -->
...
function handleTableDelete(element) {
    ...
    form.action = `/admin/project-receved/${id}`;
