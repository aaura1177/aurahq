...
<!--             
        ...
        <img src="{{ asset('uploads/profiles/' . $user->profile_picture) }}" width="50" height="50" alt="Profile Picture">
    @else
        No Image
    @endif -->
  @if($user->profile_picture && file_exists(public_path('uploads/profiles/' . $user->profile_picture)))
    <img src="{{ url('uploads/profiles/' . $user->profile_picture) }}" width="50" height="50" alt="Profile Picture">
@else
    <span>No Image</span>
@endif
...
popupUpInnerEdit.classList.add("active");
    ...
    const profile_picture = element.getAttribute('data-profile_picture');
    ...
    document.getElementById('editProfile').value = profile_picture;
